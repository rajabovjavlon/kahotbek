...
export const AVATARS = [
  { id: "av1", emoji: "⚡", name: "Kiber-Yashin", bg: "#6366f1" },
  { id: "av2", emoji: "🤖", name: "AI Bot", bg: "#8b5cf6" },
  { id: "av3", emoji: "🐱", name: "Neon Mushuk", bg: "#ec4899" },
  { id: "av4", emoji: "🥷", name: "Kiber Ninja", bg: "#10b981" },
  { id: "av5", emoji: "🚀", name: "Kosmonavt", bg: "#0ea5e9" },
  { id: "av6", emoji: "👑", name: "Qirolich / Shoh", bg: "#f59e0b" },
  { id: "av7", emoji: "🦁", name: "Sher", bg: "#f97316" },
  { id: "av8", emoji: "🔥", name: "Olov Qahramon", bg: "#ef4444" },
  { id: "av9", emoji: "🧙‍♂️", name: "Sehrgar", bg: "#a855f7" },
  { id: "av10", emoji: "💎", name: "Olmos Master", bg: "#06b6d4" },
  { id: "av11", emoji: "🧠", name: "Zakovat", bg: "#14b8a6" },
  { id: "av12", emoji: "🐉", name: "Ajdaho", bg: "#d946ef" }
];

export const BOT_NAMES = [
  { name: "Jasur Pro", avatar: "⚡", score: 0 },
  { name: "Malika IT", avatar: "🤖", score: 0 },
  { name: "Sardor Neo", avatar: "🥷", score: 0 },
  { name: "Zuhra Geek", avatar: "🐱", score: 0 },
  { name: "Bekzod IQ", avatar: "🧠", score: 0 },
  { name: "Madina Code", avatar: "💎", score: 0 },
  { name: "Temur Xon", avatar: "👑", score: 0 },
  { name: "Fotima Dev", avatar: "🚀", score: 0 }
];
